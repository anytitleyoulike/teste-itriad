...
use iTriadBundle\Entity\Projeto;
use iTriadBundle\Form\ProjetoType;
...
class ProjetoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $projetos = $em->getRepository('iTriadBundle:Projeto')->findAll();
    ...
    {
        $projeto = new Projeto();
        $form = $this->createForm('iTriadBundle\Form\ProjetoType', $projeto);
    ...
    {
        $deleteForm = $this->createDeleteForm($projeto);
        $editForm = $this->createForm('iTriadBundle\Form\ProjetoType', $projeto);
