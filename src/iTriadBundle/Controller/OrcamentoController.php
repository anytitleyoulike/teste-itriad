...
use iTriadBundle\Entity\Orcamento;
use iTriadBundle\Form\OrcamentoType;
...
class OrcamentoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $orcamentos = $em->getRepository('iTriadBundle:Orcamento')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('iTriadBundle\Form\OrcamentoType', $orcamento);
    ...
    {
        $deleteForm = $this->createDeleteForm($orcamento);
        $editForm = $this->createForm('iTriadBundle\Form\OrcamentoType', $orcamento);
