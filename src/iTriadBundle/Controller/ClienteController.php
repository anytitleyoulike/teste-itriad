...
use iTriadBundle\Entity\Cliente;
use iTriadBundle\Form\ClienteType;
...
class ClienteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $clientes = $em->getRepository('iTriadBundle:Cliente')->findAll();
    ...
    {
        $cliente = new Cliente();
        $form = $this->createForm('iTriadBundle\Form\ClienteType', $cliente);
    ...
    {
        $deleteForm = $this->createDeleteForm($cliente);
        $editForm = $this->createForm('iTriadBundle\Form\ClienteType', $cliente);
    ...
    /**
    * @Route("/teste", name="cliente_teste")
    **/
