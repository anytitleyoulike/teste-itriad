...
use iTriadBundle\Entity\Funcionario;
use iTriadBundle\Form\FuncionarioType;
...
class FuncionarioController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $funcionarios = $em->getRepository('iTriadBundle:Funcionario')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('iTriadBundle\Form\FuncionarioType', $funcionario);
    ...
    {
        $deleteForm = $this->createDeleteForm($funcionario);
        $editForm = $this->createForm('iTriadBundle\Form\FuncionarioType', $funcionario);
