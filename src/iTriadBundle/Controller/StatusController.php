...
use iTriadBundle\Entity\Status;
use iTriadBundle\Form\StatusType;
...
class StatusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $statuses = $em->getRepository('iTriadBundle:Status')->findAll();
    ...
    {
        $status = new Status();
        $form = $this->createForm('iTriadBundle\Form\StatusType', $status);
    ...
    {
        $deleteForm = $this->createDeleteForm($status);
        $editForm = $this->createForm('iTriadBundle\Form\StatusType', $status);
